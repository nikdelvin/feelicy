...
const Game: Component = () => {
    ...
    const innerWidth = document.querySelector('#game-div')!.getBoundingClientRect().width
    ...
    return (
        <div class="relative overflow-hidden">
            <div
                id="game-canvas-div"
                class="canvas-card relative aspect-video w-full"
            >
                <div
                ...
                <div
                    class="!mt-0 aspect-video w-full"
